...
public class BlockTransformiumSeed extends BlockBasic implements ITileEntityProvider {
    ...
    /*public void onBlockAdded(World world, int x, int y, int z) {
        ...
        if (world.isBlockIndirectlyGettingPowered(x, y, z)) {
            this.ignite(world, x, y, z, world.getBlockMetadata(x, y, z), (EntityLivingBase) null);
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block block) {
        if (world.isBlockIndirectlyGettingPowered(x, y, z)) {
            this.ignite(world, x, y, z, block.getDamageValue(world, x, y, z), (EntityLivingBase) null);
            world.setBlockToAir(x, y, z);
        }
    }*/

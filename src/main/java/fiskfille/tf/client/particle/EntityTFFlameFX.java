...
public class EntityTFFlameFX extends EntityFX {
    ...
    public void func_180434_a(WorldRenderer tesselator, Entity entity, float x, float y, float z, float r, float g, float b) {
        float f6 = ((float) this.particleAge + x) / (float) this.particleMaxAge;
        this.particleScale = this.flameScale * (1.0F - f6 * f6 * 0.5F);
        super.func_180434_a(tesselator, entity, x, y, z, r, g, b);
    }
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isAirBlock(new BlockPos((int) posX, (int) posY, (int) posZ))) {
            this.setDead();
        }
    }
}
...
public class RenderDisplayPillar extends TileEntitySpecialRenderer
{
    ...
    public void renderModelAt(TileEntityDisplayPillar displayPillar, double x, double y, double z, float f)
    {
        ...
        if (displayItem != null)
        {
            ...
            ModelBaseVehicle vehicle = getModelFromStack(displayItem);
    ...
    public ModelBaseVehicle getModelFromStack(ItemStack displayItem)
    {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float partialTicks, int i)
    {
